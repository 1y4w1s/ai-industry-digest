...
### Phase 3
- [x] 浅色/深色/跟随系统三种模式正常切换（侧栏新增「设置」入口，全站变量覆盖）
- [x] 字号三档切换有效（13px / 15px / 17px，body 字体继承 + 硬编码替换为 CSS 变量）
- [x] 所有偏好刷新后保持（localStorage 持久化）

### Phase 4
- [x] `/auth/stats` 接口返回数据正确
- [x] 个人中心显示总阅读数、总收藏数、连续天数
- [x] 月度热力图正确渲染
- [x] 来源分布/标签云/重要性偏好正确展示
